...
public class KonwDialog extends Dialog implements View.OnClickListener{
    ...
    private EmphasisTextView user_konw_tv;
    ...
    * */
    private void initView(){
        ...
        user_konw_tv= (EmphasisTextView) findViewById(R.id.user_konw_tv);
        user_konw_tv.setTextToHighlight("超证");
        user_konw_tv.setTextHighlightColor(android.R.color.holo_orange_light);
        user_konw_tv.setCaseInsensitive(false);
        user_konw_tv.setHighlightMode(HighlightMode.TEXT);
        user_konw_tv.highlight();
    }
