...
//
            ...
            public void ResponError(VolleyError volleyError) {
                ToastUtil.showMessage(AnnualDetailActivity.this, "网络连接失败,无法发送请求");
            }
        });
    }
        ...
        builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (status.equals("1")) {
                    ...
                    ToastUtil.showMessage(AnnualDetailActivity.this, status + "状态下不能删除");
                }
            }
        });
        builder.show();
            ...
            public void ResponseResult(Object jsonObject) {
                try {
                    ...
                    if (status.equals("ok")) {
                        ...
                        ToastUtil.showMessage(AnnualDetailActivity.this, "删除成功");
                    } else {
                       if(jsonObject1.has("show_msg")){
                           ToastUtil.showMessage(AnnualDetailActivity.this, jsonObject1.optString("show_msg"));
                       }
                    }
                    ...
                    e.printStackTrace();
                    ToastUtil.showMessage(AnnualDetailActivity.this, "删除失败");
                }
            }
